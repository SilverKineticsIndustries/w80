...
public class UserDeactivatedEvent
    : EventBase<UserDeactivatedEvent>
{
    public UserDeactivatedEvent(ObjectId createdBy, DateTime createdUTC, Entities.User user, RequestSourceInfo requestSourceInfo)
