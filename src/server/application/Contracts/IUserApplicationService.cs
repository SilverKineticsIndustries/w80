...
public interface IUserApplicationService
{
    ...
    Task<ComplexResponseDto<UserProfileViewDto>> UpdateAsync(UserProfileUpdateRequestDto userProfile, RequestSourceInfo requestSourceInfo, CancellationToken cancellationToken );
